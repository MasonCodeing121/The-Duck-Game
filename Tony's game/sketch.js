...
function _applyFill() {
  if (_doFill) { ctx.fillStyle = _colorStr(_fill); ctx.fill(); }
}
function _applyStroke() {
  if (_doStroke) { ctx.strokeStyle = _colorStr(_stroke); ctx.lineWidth = _lineWidth; ctx.stroke(); }
}
...
function rect(x, y, w, h, r) {
  ...
  ctx.beginPath();
  if (r) { ctx.roundRect(rx, ry, w, h, r); }
...
function honk() {
  ...
  if (ducks.U) {
    if (ducks.L) { ducks.d = lerp(ducks.d, -180, 0.1); }
    else         { ducks.d = lerp(ducks.d,  180, 0.1); }
  }
...
function carrot() {
  ...
  endShape();
  fill(179, 157, 117);
  ellipse(-28, 39, 30, 20); ellipse(-5, 48, 27, 20);
  ellipse(33, 43, 27, 20);  ellipse(55, 46, 30, 20);
  fill(207, 195, 157);
  ellipse(-45, 39, 30, 20); ellipse(-24, 48, 27, 20);
  ellipse(16, 47, 27, 20);  ellipse(48, 39, 30, 20);
  pop();
...
var tree = function () {
  ...
  noStroke();
  beginShape();
  vertex(127, yy + 193); vertex(148, yy + 201); vertex(160, yy + 209);
  vertex(161, yy + 213); vertex(161, yy + 203); vertex(162, yy + 233);
  vertex(166, yy + 296); vertex(167, yy + 314); vertex(154, yy + 336);
  vertex(141, yy + 346); vertex(124, yy + 351); vertex(103, yy + 355);
  vertex(167, yy + 355); vertex(184, yy + 352); vertex(186, yy + 364);
  vertex(179, yy + 375); vertex(210, yy + 364); vertex(213, yy + 363);
  vertex(217, yy + 359); vertex(223, yy + 355); vertex(229, yy + 357);
  vertex(290, yy + 357); vertex(264, yy + 344); vertex(251, yy + 325);
  ...
  fill(71, 43, 26, 100);
  beginShape();
  vertex(238, yy + 195); vertex(236, yy + 200);
  endShape(CLOSE);
  beginShape();
  ...
  endShape(CLOSE);
  beginShape();
  vertex(146, yy + 355); vertex(181, yy + 318); vertex(185, yy + 351);
  endShape(CLOSE);
};
...
for (var i = 0; i < 155; i++) {
  treeleaves.push({
    xx: random(39, 127), zz: random(50, 121),
    ww: random(10, 50),  jj: random(10, 50)
  });
}
...
function pancakes(x, y) {
  ...
  noStroke();
  fill(207, 207, 207);
  ellipse(0, 0, 50, 15); ellipse(0, 3, 40, 15);
      ...
      case "back":
        if (pankakes[i].y < ducks.y + 13) {
          ...
          if (dist(ducks.x, ducks.y, pankakes[i].x, pankakes[i].y) < 40) {
            ducks.pancakes++; pankakes.splice(i, 1);
          }
        }
        break;
      case "front":
...
function game() {
  ...
  function drawLeaves(tx, ty, sc) {
    for (var j = 0; j < treeleaves.length; j++) {
      ...
      if (sc) scale(sc);
      fill(69, 138, 35);
      ellipse(treeleaves[j].xx, treeleaves[j].zz - 50, treeleaves[j].ww, treeleaves[j].jj);
      fill(61, 128, 26);
      ellipse(treeleaves[j].xx, treeleaves[j].zz,      treeleaves[j].ww, treeleaves[j].jj);
      pop();
    }
  }
  ...
  dirt();
  if (ducks.y < 30) {
    duck(ducks.x, ducks.y); carrot();
  } else {
    carrot(); duck(ducks.x, ducks.y);
  }
...
function menu() {
  ...
  textSize(190);
  fill(0);   text("🦆", 350, 118);
  fill(255); text("🦆", 350, 120);
  textSize(20);
  fill(0);   text("click duck to start", 147, 224);
  fill(255); text("click duck to start", 147, 226);
  textSize(25);
...
function how() {
  ...
  textSize(35);
  fill(0);   text("Menu", 0, -2);
  fill(255); text("Menu", 0, 0);
  textSize(120);
  fill(255); text("⇦", -5, 4);
  pop();
  textSize(50);
  fill(255); text("how?", 300, 44);
  textSize(27);
  fill(255); text("1. Be duck\n\n2. Collect pancakes,\n3. Feed said pancakes to carrot,\n4. Watch carrot\ngrow\n5. Repeat\n\n[W]\n[A][S][D]\nto move\n\n[space] to sprint", 300, 329);
  fill(255);
  textSize(15);
...
function draw() {
  ...
  switch (scene) {
    case "game":
      game();
      var distance_carrot = dist(ducks.x, ducks.y, -5, 48);
      textFont("Comic Sans MS");
      textSize(15);
      fill(0); noStroke();
      var rounded = round(distance_carrot / 50);
      text("Meters from carrot: " + rounded, 93, 46);
      var carrot_size = round(carrott.sz);
      text("Carrot size: " + carrot_size, 93, 29);
      break;
    case "menu":
      menu();
      break;
